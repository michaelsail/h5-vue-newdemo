<template>
  <div>
    ...
    <van-sticky :offset-top="90">
      <div id="bar">
        <div class="hall_tab pl15 bg_white hidden">
        ...
        <DiagFilterBar @scrollToTop="scrollToTop" @update="changeFilterDiag" v-show="checkTab=='doc'" />
        <CheckFilterBar @scrollToTop="scrollToTop" @update="changeFilterCheck" v-show="checkTab=='check'" />
      </div>
    </van-sticky>
...
export default {
  ...
  mounted() {
    ...
    this.$nextTick(()=>{
      if(this.$route.query.checkTab=='check'){
      this.checkTab = 'check'
    }
    })
    this._getHalldoctor()
